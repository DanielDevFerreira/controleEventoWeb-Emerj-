...
<body>
    ...
    <div id="title">
        <center>
            <spam>UPLOAD DO ARQUIVO CSV</spam>
        </center>
    </div>        
		...
		<fieldset>
            ...
            <br>
                ...
                <input style="width: 277px" type="text" id="codEvento" name="codEvento" class="form-control" placeholder="Código Evento" required><br>
            ...
            <form id="form2" action="#" method="post">
                ...
                <select class="form-control" id="tamanho" name="tamanho">
                    ...
                    <option value="InsertNovo">Inserir novos Participantes Válidos</option>
                    <option value="Inserir_Inscricao" >Realizar inscrição dos Participantes Válidos</option>
                </select>
	<br>
