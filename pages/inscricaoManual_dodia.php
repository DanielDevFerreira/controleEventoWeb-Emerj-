...
<script language="JavaScript" src="../js/validador.js"></script>
    ...
    <body>
        ...
        <div id="title"><center><spam>INSCRIÇÃO MANUAL EM EVENTOS DO DIA</spam></center></div>
        <div class="container">
...
<div class="row">
  ...
  <?php
        // busca evento da data atual

if ((isset($_POST["hdAcao"])) && ($_POST["hdAcao"] == "buscar")) {
	
	$query_rsBusca = "SELECT DISTINCT e.codigo, e.nome, po.data, po.codEvento 
