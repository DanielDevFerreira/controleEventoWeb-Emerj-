...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	function listaInscricoes() {        
        ...
        if(confirm('Deseja realmente apurar este evento ?')){
...
<?php
            ...
            if (empty($_POST["dataInicial"]) && empty($_POST["dataFinal"])) {
                ...
                $query = "SELECT DISTINCT p.codEvento as Código, e.nome as 'Nome do Evento' from evento e,  porta p WHERE data between " . $retornaDataInicialInvertida . " AND " . $retornaDataFinalInvertida . " AND e.codigo = p.codEvento";
    ...
    <div class="col-md-2  pull-right">
        <input class="btn btn-primary" name='btListaInscricoes' type='button' id='btListaInscricoes' onClick='listaInscricoes();' value='Apurar Frequência' />    
    </div>    
    </div>
    </div>    
    </div>
