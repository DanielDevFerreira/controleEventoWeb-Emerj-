            ...
            <div class="row">
                <div class="form-group">
                    <div class="col-md-5 col-xs-6">
                        <br>
                        <label style="font-size: 17px;" for="valor">Código do Evento:</label>
...
<div class="container">
    ...
    <table width='850px' border='1' align='center' class='table table-striped'>
        ...
        <tr class='TDdata'>
            ...
            echo"<td style='font-size: 1.2em;' colspan='5' class='TDtable1' align='center'>". $vetHora['nome']. " - Hora Início ". $vetHora['horaInicio']. " - Hora Fim  ". $vetHora['horaFim']. " </td>";
    ...
    if(!isset($_POST['listaParticipante'] )){
        ...
        foreach ($_POST['listaParticipante'] as $lista) {
            ...
            $queryInsertFrequencia = "INSERT INTO frequencia2 (codEvento, codParticipante, dataPorta, horaPorta, cargaHorariaOAB, tipoCargaHoraria, dataAtribuida, permanencia, percentual)
                        VALUES ('$resutLista[0]','$resutLista[1]','$resutLista[2]','$resutLista[3]','$resutLista[4]','3', '$stringDataAtual' ,'$resutLista[4]', '1')";
