...
if(isset($_POST['valorselecionado']) && $_POST['valorselecionado'] != "") {
    ...
    //nome do servidor
    $Mailer->Host = '@emerj.com.br';
    //Porta de saida de e-mail
    $Mailer->Port = 587;

    //Dados do e-mail de saida - autenticação
    $Mailer->Username = 'emerjsite@tjrj.jus.br';
    $Mailer->Password = '';

    //E-mail remetente (deve ser o mesmo de quem fez a autenticação)
    $Mailer->From = 'emerjsite@tjrj.jus.br';

    //Nome do Remetente
    $Mailer->FromName = 'EMERJ';

    //Assunto da mensagem
    $Mailer->Subject = 'EVENTOS EMERJ: Link para Alteração de Dados Cadastrais';
    ...
    //Destinatario
    $Mailer->AddAddress('danielplay78@hotmail.com');
